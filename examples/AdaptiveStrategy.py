...
class AdaptiveStrategy(DefaultStrategy):
    ...
    def _update_geometry(self, params: dict, optimizers: dict, state: dict, step: int) -> Tuple[int, int, int, int]:
        ...
        continuous_params_for_split_candidates = continuous_params_post_merge[split_mask_on_active]
        ...
        if len(split_candidate_orig_indices) > 0:
            ...
            final_split_params = continuous_params_for_split_candidates[valid_remapped_mask]
        ...
        continuous_params_for_dupe_candidates = continuous_params_post_split[dupe_mask_on_active]
        ...
        if len(dupe_candidate_orig_indices) > 0:
            ...
            final_dupe_params = continuous_params_for_dupe_candidates[valid_remapped_mask]
